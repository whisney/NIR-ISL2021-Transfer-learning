...
new_dir = 'NIR-ISL2021_predictions/CASIA-Iris-M1'
M1_save_dir = os.path.join(new_dir, 'CASIA-Iris-M1')
os.makedirs(os.path.join(M1_save_dir, 'Inner_Boundary'), exist_ok=True)
os.makedirs(os.path.join(M1_save_dir, 'Outer_Boundary'), exist_ok=True)
