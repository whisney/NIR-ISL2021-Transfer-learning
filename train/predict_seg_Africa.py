...
Africa_name_list = os.listdir('data/testing/CASIA-Iris-Africa/test/image')

model_path = [
    '/home/zyw/NIR_ISL2021/trained_models/Africa/Seg/finetune_UNet_ResNet34/bs16_epoch200_fold0/best_acc.pth',
    '/home/zyw/NIR_ISL2021/trained_models/Africa/Seg/baseline_UNet_ResNet34/bs16_epoch500_fold1/best_dice.pth',
    '/home/zyw/NIR_ISL2021/trained_models/Africa/Seg/finetune_UNet_ResNet34/bs16_epoch200_fold2/best_acc.pth',
    '/home/zyw/NIR_ISL2021/trained_models/Africa/Seg/baseline_UNet_ResNet34/bs16_epoch500_fold3/best_dice.pth',
    '/home/zyw/NIR_ISL2021/trained_models/Africa/Seg/finetune_UNet_ResNet34/bs16_epoch200_fold4/best_acc.pth'
]

new_dir = 'trained_models/NIR-ISL2021030401_1/CASIA-Iris-Africa'
Africa_save_dir = os.path.join(new_dir, 'CASIA-Iris-Africa', 'SegmentationClass')
os.makedirs(Africa_save_dir, exist_ok=True)

img_name_dicts = [{'data_dir': 'data/testing/CASIA-Iris-Africa/test/image', 'save_dir': Africa_save_dir,
                   'name_list': Africa_name_list}]
