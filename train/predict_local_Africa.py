...
Africa_save_dir = os.path.join(new_dir, 'CASIA-Iris-Africa')
os.makedirs(os.path.join(Africa_save_dir, 'Inner_Boundary'), exist_ok=True)
os.makedirs(os.path.join(Africa_save_dir, 'Outer_Boundary'), exist_ok=True)
